...
* expire: 这个url多长时间失效
* 请求方法: GET请求表单
* 请求url: http://serv_pro:15673/file/get_video_first_photo, serv_pro:15673由实际的ip和端口替换
* 代码例子:

```
import requests

get_video_first_photo_url = 'http://serv_pro:15673/file/get_video_first_photo'
form_data = {
    'api_key': api_key,
    'third_user_id': third_user_id,
    'category_id': category_id,
...
r = requests.get(get_video_first_photo_url, data=form_data)
r.raise_for_status()
jd = r.json()
if jd['status'] == 0:
    print(None)
...
* expire: 这个url多长时间失效
* 请求方法: GET请求表单
* 请求url: http://serv_pro:15673/file/get_many_video_first_photo, serv_pro:15673由实际的ip和端口替换
* 代码例子:

```
import requests

get_many_video_first_photo_url = 'http://serv_pro:15673/file/get_many_video_first_photo'
form_data = {
    'api_key': api_key,
    'data': [
        {
...
r = requests.get(get_many_video_first_photo_url, data=form_data)
r.raise_for_status()
jd = r.json()
if jd['status'] == 0:
    print(None)
